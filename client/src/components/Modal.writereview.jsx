        ...
        <Modal isOpen={this.state.inputModal} style={customStyles}>
          ...
          <Gridform id="reviewform" onSubmit={this.handleSubmit}>
            ...
            <TopSelectors>
              ...
              <span>Average</span>
              <br />
              <input type="radio" name="comfort" value="6" />
              <span>Very Comfortable</span>
            </TopSelectors>
            <TopSelectors>
              Durability:
              <br />
              <input type="radio" name="prod_durability" value="7" />
              <span>Not Durable</span>
              <br />
              <input type="radio" name="prod_durability" value="8" />
              <span>Average</span>
              <br />
              <input type="radio" name="prod_durability" value="9" />
              <span>Very Durable</span>
            </TopSelectors>

            <Line />

            <Divcol>Review Title:</Divcol>
            ...
            <FormTextArea type="text" name="city" />

            <Divcol>Use for:</Divcol>
